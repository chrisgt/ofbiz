...
factory.findMatchingLabels(null, null, null, '*',)
//context.localesFound = factory.getLocalesFound();
//context.labels = factory.getLabels();
// total num of labels
context.labelsCount = factory.getLabelsCount();
// every available Locale
context.langsCount = factory.getLocalesFound().size();

// Map with lang/num labels
context.localesCount = factory.getLocalesCount();
